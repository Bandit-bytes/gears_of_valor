...
public class ItemRegistry {
    ...
    static Item.Properties PaladinProps = new Item.Properties().durability(490).stacksTo(1).rarity(Rarity.EPIC).arch$tab(TabRegistry.GEARS_TAB);
    static Item.Properties WoodlandProps = new Item.Properties().durability(440).stacksTo(1).rarity(Rarity.RARE).arch$tab(TabRegistry.GEARS_TAB);
    static Item.Properties ReaperProps = new Item.Properties().durability(510).stacksTo(1).rarity(Rarity.EPIC).arch$tab(TabRegistry.GEARS_TAB);
